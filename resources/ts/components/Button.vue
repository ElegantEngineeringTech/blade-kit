...
<template>
  <component :is="computedTag" class="el-button el-spacing el-text el-bg el-ring el-outline el-border" :data-size="size"
    :data-color="color" :data-color-checked="colorChecked" :disabled="disabled || null" :type="computedType"
    :download="download || null" :data-loading="loading || null">
    <slot name="before" />
    <slot name="input" />
    ...
    <span v-if="slots.default" class="relative inline-flex min-w-0" :class="{
